...
export const workData = [
    ...
    },
    {
        ...
        description: 'Web page making and learning',
        bgImage: '/sapient.jpg'
    },
    {
        title: 'Accessibility Consultant',
        description: 'Analyzing web pages aginst WCAG',
        bgImage: '/cognizant.jpg.png'
    },
]

export const serviceData = [
    {
        icon: assetsImages.webicon, 
        title: 'Web development',
        description: 'web development using different fe techs',
        link: ''
    },
    {
        icon: assetsImages.mobile, 
        title: 'Mobile development',
        description: 'web development using different fe techs',
        link: ''
    },
    {
        icon: assetsImages.accessibility, 
        title: 'Web accessibility',
        description: 'web development using different fe techs',
        link: ''
    },
    {
        icon: assetsImages.yoga, 
        title: 'Yoga',
